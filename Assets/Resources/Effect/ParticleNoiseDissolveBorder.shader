Shader "Custom/ParticleNoiseDissolveBorder"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                //在(顶点->摄像机)方向做偏移
                float3 offsetVector = normalize(_WorldSpaceCameraPos - worldPos);
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                half dissolve = tex2D(_DissolveTex, uv);
